...
Процедура РассчитатьОтпуск()
    ...
    Запрос.Текст = 
        ...
        |////////////////////////////////////////////////////////////////////////////////
        |ВЫБРАТЬ
        |	РАЗНОСТЬДАТ(ВКМ_НачислениеЗарплатыОсновныеНачисления.ДатаНачала,
        |		ВКМ_НачислениеЗарплатыОсновныеНачисления.ДатаОкончания, ДЕНЬ) + 1 КАК Отпуск,
        |	ВТ1.НомерСтроки КАК НомерСтроки,
        |	ВТ1.БазаОсн КАК БазаОсн,
        |	ВТ1.БазаДоп КАК БазаДоп,
        |	ВТ1.БазаОтработано КАК БазаОтработано,
        |	ВТ1.Факт КАК Факт,
        ...
        |	ВТ1 КАК ВТ1
        |ГДЕ
        |	ВКМ_НачислениеЗарплатыОсновныеНачисления.ВидРасчета = &ВидРасчета
        |	И ВКМ_НачислениеЗарплатыОсновныеНачисления.Ссылка = &Ссылка";
    ...
    Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
        ...
        Движение2.Период = Дата;
        Движение2.Сотрудник = ВыборкаДетальныеЗаписи.Сотрудник;
        Движение2.Сумма = Движение.Размер;
