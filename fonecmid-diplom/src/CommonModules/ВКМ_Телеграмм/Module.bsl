...
Процедура BKM_ОтправитьУведомлениеВТелеграмм() Экспорт
	...
	Если Не ЗначениеЗаполнено(ИдентификаторЧата) Тогда
		ЖурналРегистрации.ДобавитьСообщениеДляЖурналаРегистрации("Отправка сообщения в телеграмм. Сообщение не отправлено.", 
		УровеньЖурналаРегистрации.Ошибка,,, "Идентификатор чата для Телеграмм не установлен.");
		Возврат;
	КонецЕсли;
...
Функция ОтправитьСообщениеВТелеграмм(Знач ТекстСообщения, Знач Токен, Знач ИдентификаторЧата)
	...
	Исключение
		...
		ЖурналРегистрации.ДобавитьСообщениеДляЖурналаРегистрации("Отправка сообщения в телеграмм. Непредвиденная ошибка.", 
		 	УровеньЖурналаРегистрации.Ошибка,,,ОписаниеОшибки());
